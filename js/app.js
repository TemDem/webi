 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new core(".acquaintance__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (videosBlock.length) videosBlock.forEach((el => {
            ...
            const full = document.querySelector(".nav-video__screen");
            const time = document.querySelector(".nav-video__time");
